...
def main():
    # 这里写主函数的逻辑
    commu1 = {{0,1,2,3,7,8,12,13,14,15,17,18,19,20,21,22,23,26,27,28,29,30,31,32,33},{0,16,4,5,10},{24,25,31}}
    commu2 = {{0,1,2,3,7,8,12,13,14,15,17,18,19,20,21,22,23,26,27,28,29,30,31,32,33},{5,6,24,25,31}}
